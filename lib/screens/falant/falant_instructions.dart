...
class FalantInstructions extends StatelessWidget {
  const FalantInstructions({Key? key}) : super(key: key);
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            const Padding(
              padding: EdgeInsets.symmetric(horizontal: 20),
              child: Text(
                '1. Ensure that your device settings are normal (brightness, contrast, and color).\n\n2. Take the test in a well-lit room with no glare or reflections on the screen.\n\n3. Hold your device at a comfortable viewing distance and angle.\n\n4. Follow the on-screen instructions to identify the colored lights against different colored backgrounds. If you have trouble seeing the lights, consult an eye doctor.\n\n\nAfter the test, your results will be displayed and saved for future reference.',
                style: TextStyle(
                  color: mainTheme,
                  fontFamily: 'DM Sans Regular',
                  fontSize: 18.0,
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  Navigator.of(context).push(
                    MaterialPageRoute(builder: (context) => const Falant()),
                  );
                },
                child: const Text(
                  'Start Test',
