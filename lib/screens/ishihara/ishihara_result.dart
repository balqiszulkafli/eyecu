...
class IshiharaResult extends StatefulWidget {
  final int score;
  final bool isPassed;
  final String result;
  ...
  @override
  State<IshiharaResult> createState() => _IshiharaResultState();
}

class _IshiharaResultState extends State<IshiharaResult> {
          ...
          children: <Widget>[
            ...
            Row(
              children: [
                const Padding(
                    padding: EdgeInsets.symmetric(vertical: 0, horizontal: 20)),
                Text(
                  "You are most likely ${widget.result}",
            ...
            SizedBox(
              ...
              child: Card(
                ...
                child: Center(
                  child: Text(
                    "${widget.score} / ${questionList.length}",
                    ...
                    child: ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.pushReplacement(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => const Ishihara()));
                        },
                        child: const Text(
                          "Reset",
                          style: TextStyle(
